<html>
    <head>
        ...
        <style>
            ...
            .flex-me > div > button, .flex-me > div > form > input {
            ...
            <div id="content">
                ...
                <div class="flex-me">
                    ...
                    <div>
                        ...
                        <a id="save-still" href="#" class="button save">Save image</a>
                        
                        <form action="insert.php" method="post">
                            <input type="text" value="" id="send" name="image" style="display : none;">
                            <input id="save-img" type="submit" name="image_url" value="Save Image">
                        </form>
                    </div>
                </div>
            </div>
...
document.addEventListener('DOMContentLoaded', function (event) {
  var baseHost = 'http://YOUR ESP 32 IP ADDRESS CONNECTION'
  ...
  saveButton.onclick = () => {
    ...
    try {
    let forA = document.querySelector('#send')
